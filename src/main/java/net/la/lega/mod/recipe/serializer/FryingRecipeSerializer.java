...
public class FryingRecipeSerializer implements RecipeSerializer<FryingRecipe>
{
    private FryingRecipeSerializer()
    {
    }
    
    public static final FryingRecipeSerializer INSTANCE = new FryingRecipeSerializer();
    public static final Identifier ID = new Identifier(LLoader.MOD_ID, FryingRecipe.recipeID);
    
    @Override public FryingRecipe read(Identifier id, JsonObject json)
    {
        ...
        return new FryingRecipe(input, output, processingTime, id);
    }
    
    @Override public FryingRecipe read(Identifier id, PacketByteBuf buf)
    {
    ...
    @Override public void write(PacketByteBuf buf, FryingRecipe recipe)
    {
