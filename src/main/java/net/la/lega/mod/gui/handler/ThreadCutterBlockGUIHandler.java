...
public class ThreadCutterBlockGUIHandler extends SyncedGuiDescription
{
    ...
    {
        super(LGUIHandlers.THREAD_CUTTER_SCREEN_HANDLER, syncId, playerInventory, getBlockInventory(context, 1), getBlockPropertyDelegate(context, AProcessingEntity.PROPERTY_SIZE));
