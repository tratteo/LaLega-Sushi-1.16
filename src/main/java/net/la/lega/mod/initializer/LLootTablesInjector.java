...
public final class LLootTablesInjector
{
    ...
    public static void initialize()
    {
        LootTableLoadingCallback.EVENT.register((resourceManager, lootManager, id, supplier, setter) ->
        {
            ...
            {
                FabricLootPoolBuilder poolBuilder = FabricLootPoolBuilder.builder().rolls(UniformLootTableRange.between(2, 4)).withEntry(ItemEntry.builder(LItems.RAW_SQUID).build());
